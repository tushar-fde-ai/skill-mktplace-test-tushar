...
> | NBA solution sub-folder | `NBA Engagement Scores - <Customer Name>` |
> | Requirements gathering page | `NBA Requirements Gathering - <Customer Name>` |
> | Configuration summary page | `NBA Configuration Summary - <Customer Name>` |
> | Architecture & schema page | `NBA Architecture & Output Schema - <Customer Name>` |
> | Runbook page | `NBA Runbook & Maintenance - <Customer Name>` |
>
