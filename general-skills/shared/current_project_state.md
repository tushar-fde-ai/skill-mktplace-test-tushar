...
createConfluencePage:
  ...
  body: |
    ...
    ## Artifact URLs
    - Customer template branch: <pending or `https://github.com/<org>/<template-repo>/tree/customer/<slug>`>
...
| Phase 2 push | Current phase → 3, project name + push date in Key Decisions, **customer template branch URL** |
